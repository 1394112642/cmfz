    ...
    <script>
        ...
        $(function () {
            ...
            $("#captchaImage").click(function () {
                $("#captchaImage").prop("src", "${path}/img/img?t=" + new Date().getTime())
            })
            $.extend($.validator.messages, {
                required: "<span style='color: red'>必须写</span>"
            })
                ...
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    <div class="form-top" style="width: 450px">
                        <div class="form-top-left">
                            ...
                            <p>Enter your username and password to log on: <strong><span id="sp"
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="" method="post" class="login-form" id="loginForm">
                            ...
                            <div class="form-group">
                                <img id="captchaImage" style="width: 105px;height: 45px" class="captchaImage"
                                     src="${path}/img/img">
